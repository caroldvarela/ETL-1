...
class CauseOfDeathsDimensional(BASE):
    ...
    CardiovascularDeaths = Column(Integer, nullable=False)
    ...
    obesity_prevalence_percentage = Column(Float, nullable=False)
    diabetes_prevalence_percentage = Column(Float, nullable=False)
